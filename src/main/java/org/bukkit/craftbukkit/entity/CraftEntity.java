...
public abstract class CraftEntity implements Entity
{
    ...
    public static CraftEntity getEntity(CraftServer server, net.minecraft.entity.Entity entity) {
        ...
        if (entity instanceof net.minecraft.entity.EntityLivingBase) {
            ...
            if (entity instanceof net.minecraft.entity.player.EntityPlayer) {
                ...
                if (entity instanceof net.minecraft.entity.passive.EntityAnimal) {
                    ...
                    else if (entity instanceof net.minecraft.entity.passive.EntityRabbit) { return new CraftRabbit(server, (net.minecraft.entity.passive.EntityRabbit) entity); }
                    else if (entity instanceof net.minecraft.entity.monster.EntityPolarBear) { return new CraftPolarBear(server, (net.minecraft.entity.monster.EntityPolarBear) entity); }
                ...
                // Monsters
                    ...
                    if (entity instanceof net.minecraft.entity.monster.EntityZombie) {
                        ...
                        if(entity instanceof net.minecraft.entity.monster.EntityEndermite){
                            return new CraftEndermite(server, (net.minecraft.entity.monster.EntityEndermite) entity);
                        }
                        if(entity instanceof net.minecraft.entity.monster.EntityGuardian){
                            return new CraftGuardian(server, (net.minecraft.entity.monster.EntityGuardian)entity);
                        }
                ...
                // Water Animals
                    ...
                    else if (entity instanceof net.minecraft.entity.monster.EntityShulker) { return new CraftShulker(server, (net.minecraft.entity.monster.EntityShulker) entity); }
        ...
        else if (entity instanceof net.minecraft.entity.projectile.EntityTippedArrow) {
            if(((EntityTippedArrow) entity).isTipped()){
                return new CraftTippedArrow(server,(net.minecraft.entity.projectile.EntityTippedArrow) entity);
            }else{
                return new CraftArrow(server,(net.minecraft.entity.projectile.EntityArrow)entity);
            }
        }
        else if (entity instanceof net.minecraft.entity.projectile.EntitySpectralArrow) { return new CraftSpectralArrow(server, (net.minecraft.entity.projectile.EntitySpectralArrow) entity); }
            ...
            if (entity instanceof net.minecraft.entity.projectile.EntityEgg) { return new CraftEgg(server, (net.minecraft.entity.projectile.EntityEgg) entity); }
                ...
                return new CraftSplashPotion(server, (net.minecraft.entity.projectile.EntityPotion) entity); }
                else {
            ...
            else { return new CraftProjectile(server, entity); } // Cauldron
        }
